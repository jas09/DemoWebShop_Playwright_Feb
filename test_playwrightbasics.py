...
def test_coreLocators(page:Page):
    ...
    page.get_by_label("First name:").fill("pushpavathi7")
    page.get_by_label("Last name:").fill("Gotham1")
    page.get_by_label("Email:").fill("pushpavathi1237@example.com")
    page.locator("//input[@id='Password']").fill("pushpavathi7")
    page.locator("#ConfirmPassword").fill("pushpavathi7")
