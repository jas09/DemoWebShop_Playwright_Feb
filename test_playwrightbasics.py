...
def test_DemoWebShopRegistration(page:Page):
    ...
    page.get_by_label("First name:").fill("pushpavathi12")
    page.get_by_label("Last name:").fill("Gotham1")
    page.get_by_label("Email:").fill("pushpavathi12@example.com")
    page.locator("//input[@id='Password']").fill("pushpavathi12")
    page.locator("#ConfirmPassword").fill("pushpavathi12")
