...
def test_coreLocators(page:Page):
    ...
    page.get_by_label("First name:").fill("pushpavathi6")
    page.get_by_label("Last name:").fill("Gotham1")
    page.get_by_label("Email:").fill("pushpavathi1236@example.com")
    page.locator("//input[@id='Password']").fill("pushpavathi6")
    page.locator("#ConfirmPassword").fill("pushpavathi6")
